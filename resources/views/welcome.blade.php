...
<div class="container">
  ...
  <div class="features">
    <div class="row">
        ...
        <div class="info">
          ...
          <p>Los pedidos que realices sólo los conoceras tu a traves de tú panel de usuario. Nadie más tiene acceso a esta información.</p>
        </div>
                </div>
            </div>
  </div>
  ...
  <div class="team">
    ...
    <div class="section landing-section">
      ...
      <h4 class="text-center description">Registrate ingresando tus datos básicos, y podrás realizar tus pedidos a traves de nuestro carrito de compras. Si aún no te decides, de todas formas, con tu cuenta de usuario podrás hacer todas tus consultas sin compromiso.</h4>
